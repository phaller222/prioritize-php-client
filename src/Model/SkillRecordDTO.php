...
/**
 * SkillRecordDTO Class Doc Comment
 *
 * @category Class
 * @package  Hallerweb\Prioritize\Client
 * @author   OpenAPI Generator team
 ...
 */
class SkillRecordDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SkillRecordDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('skill_name', $data ?? [], null);
        $this->setIfExists('enthusiasm', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets skill_id
     *
     * @param int|null $skill_id skill_id
     *
     * @return self
     */
     ...
     * Sets skill_name
     *
     * @param string|null $skill_name skill_name
     *
     * @return self
     */
    public function setSkillName($skill_name)
    {
        if (is_null($skill_name)) {
            throw new \InvalidArgumentException('non-nullable skill_name cannot be null');
        }
    ...
    {
        return $this->container['enthusiasm'];
    }

    /**
     * Sets enthusiasm
     *
     * @param int|null $enthusiasm enthusiasm
     *
     * @return self
     */
    public function setEnthusiasm($enthusiasm)
    {
        if (is_null($enthusiasm)) {
            throw new \InvalidArgumentException('non-nullable enthusiasm cannot be null');
        }
        $this->container['enthusiasm'] = $enthusiasm;
