...
/**
 * ResourceReservationDTO Class Doc Comment
 *
 * @category Class
 * @package  Hallerweb\Prioritize\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResourceReservationDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceReservationDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reserved_by', $data ?? [], null);
    ...
    */
     ...
     * Sets reserved_by
     *
     * @param string|null $reserved_by reserved_by
     *
     * @return self
     */
    public function setReservedBy($reserved_by)
    {
        if (is_null($reserved_by)) {
            throw new \InvalidArgumentException('non-nullable reserved_by cannot be null');
        }
     ...
     * Sets slot_number
     *
     * @param int|null $slot_number slot_number
     *
     * @return self
     */
