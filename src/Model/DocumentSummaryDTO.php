 ...
 */
class DocumentSummaryDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentSummaryDTO';
    ...
    */
    ...
    public function setLockedBy($locked_by)
    {
        if (is_null($locked_by)) {
            throw new \InvalidArgumentException('non-nullable locked_by cannot be null');
        }
